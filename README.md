...
## Key Files & Structure
- `preprocess_*.ipynb`: Data cleaning and feature engineering for income, population, and restaurant license data.
- `data_merging.ipynb`: Integrating multiple datasets into a single master frame for analysis.
- `data_visualization.ipynb`: Statistical plotting and correlation heatmaps.
- `final_merged_data.csv`: The final dataset used for the study.
- `analysis_report.pdf`: Comprehensive research paper summarizing the findings and policy recommendations.
